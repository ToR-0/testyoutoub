...
from authy.views import UserProfile, Signup, PasswordChangeDone, PasswordChangeDone, EditProfile
...
urlpatterns = [
    ...
    path('changepassword/', PasswordChangeDone, name='change_password'),
